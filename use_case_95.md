# Use Case 95: Using Cloudflare Workers for A/B Testing
...
In this example, the worker checks if the incoming request has a cookie that indicates which variant to serve. If not, it randomly selects a variant and sets a cookie to persist the visitor's variant.