# Use Case 77: Using Cloudflare Workers for A/B Testing
...
In this example, we are using a Cloudflare Worker to serve one of two variants of a webpage and persist the visitor's variant in a cookie. This allows us to consistently serve the same variant to the visitor for the duration of the A/B test.