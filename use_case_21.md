...
In this example, the worker is set up to respond with one of two variants of a webpage and sets a cookie to persist a visitor's variant. The visitor is then served the same variant on subsequent visits.